...
En \textit{ProvideDB}, solo en caso de optar por ser colaborador, se va a notificar utilizando la \textbf{DHT} que el nodo utilizado es proveedor de la base de datos utilizada. De esta manera otros nodos pueden encontrar al nodo en su busqueda de proveedores.
...
Como resultado del análisis y creación de esta infraestructura, se logró proveer de una herramienta para facilitar la creación de nuevas aplicaciones con enfoque comunitario, distribuido y descentralizado utilizando el ecosistema de IPFS.
